...
echo.
echo Step 2: Force-stopping OpenXR Tutorial Ch2...
adb shell am force-stop com.example.openxr_tutorial_ch2
if %errorlevel% equ 0 (
    echo Successfully force-stopped OpenXR Tutorial Ch2
) else (
    echo App not running or force-stop failed
)

echo.
echo Step 3: Uninstalling OpenXR Tutorial Ch2...
adb uninstall com.example.openxr_tutorial_ch2
if %errorlevel% equ 0 (
    echo Successfully uninstalled OpenXR Tutorial Ch2
) else (
...
adb shell pm clear com.example.openxr_tutorial_ch2
if %errorlevel% neq 0 (
